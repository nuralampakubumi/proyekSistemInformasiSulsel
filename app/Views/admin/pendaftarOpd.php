    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Pendaftar OPD</h1>
                    <a href="<?= base_url('admin/tambahOpd') ?> " class="btn btn-primary">Tambah Pendaftar</a>
                </div>
                <div class="col-sm-6">
                                ...
                                <tbody>
                                    <?php foreach ($result as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= site_url('admin/editDataOpd/' . $value->id) ?> " class="btn btn-info">Edit</a>
                                                <a href="<?= site_url('admin/deleteDataOpd/' . $value->id) ?> " class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
